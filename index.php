<?php include 'header.php' ?>
  <div class="latestwork"><!--index content-->
    <div class="inlatestwork">
      ...
      </div><!--FIN belowlatestwork2-->

    </div><!--FIN inlatestwork-->
  </div><!--FIN latestwork-->
